...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['product_id'])) {
    ...
    $success_message = 'Produk berhasil ditambahkan ke cart!';
}
?>
...
<?php if (!empty($success_message)): ?>
    <div class="alert alert-success text-center mb-0" style="border-radius:0;">
                     ...
                     <?php if (!empty($row['image'])): ?>
                        ...
                        <div class="card-body">
                            ...
                            <form method="post" action="">
                                <input type="hidden" name="product_id" value="<?= htmlspecialchars($row['name']) ?>">
